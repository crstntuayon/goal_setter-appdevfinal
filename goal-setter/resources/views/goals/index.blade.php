...
@foreach ($goals as $goal)
    <div class="mb-6 border-b pb-4">
        ...
        <div class="bg-gray-200 h-6 rounded overflow-hidden mt-2">
            <div
                class="bg-green-500 h-full text-white text-xs text-center"
        ...
        <form action="{{ route('goals.update', $goal) }}" method="POST" class="mt-2 inline-block">
            @csrf
            @method('PUT')
        ...
        {{-- Delete Button (only if complete) --}}
